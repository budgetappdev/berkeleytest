		...
		*/
		...
		function injectTitlePage(title,login,i){
			if($("#appML_navigation_bar").length>0 && $("#appML_navigation_bar").is(".appML_auto_fill")){
				...
				if(login!=null)
					title="Login";
				$("#appML_navigation_bar").append($("<div id='appML_navigation_bar_content'><div style='width:60%' id='navbartitle'></div><div id='backButton' class='backButton' style='display:none'>BACK</div><div id='nextButton' class='nextButton' style='display:none'>SAVE</div></div>"));
			}
		}
		...
		function hideOverlay(){
			...
			setTimeout(function(){$("#overlayContainer").html('');},500);
			overlay=false;
			$('.active').removeClass('active');
		}
	    ...
	    function translateAppML(){
	    	...
	    	var loading_html=getAppMLDiv(prefix+"loading",null,null,"<div class='appMLLoading'><div style='text-align:center'></div></div>");
