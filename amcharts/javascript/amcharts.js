...
this.percentFormatter={precision:0,decimalSeparator:".",thousandsSeparator:","};
...
var d=AmCharts.rect(this.container,1,1,"#FFFFFF",1);
var g=AmCharts.text(this.container,2,2," ".split("").reverse().join(""),{fill:"#000000","font-family":"Verdana","font-size":11,"text-anchor":"start"});
g.translate(5+","+8);
